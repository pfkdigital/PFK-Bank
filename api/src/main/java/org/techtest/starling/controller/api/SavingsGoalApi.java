...
public interface SavingsGoalApi {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved all savings goals"),
            @ApiResponse(responseCode = "404", description = "Savings goals not found"),
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Successfully created new savings goals"),
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Successfully transferred money to savings goal"),
            @ApiResponse(responseCode = "404", description = "Account not found"),

...
export const createSavingGoal = async (accountUid: string, request: CreateSavingsGoalType) => {
    try {
        const response = await fetch(`${baseUrl}/savings-goals/account/${accountUid}`, {
            method: "PUT",
